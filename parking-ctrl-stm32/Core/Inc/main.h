...
#define RIGHT_WHEEL_PC4_Pin GPIO_PIN_4
#define RIGHT_WHEEL_PC4_GPIO_Port GPIOC
#define RIGHT_WHEEL_PC5_Pin GPIO_PIN_5
#define RIGHT_WHEEL_PC5_GPIO_Port GPIOC
#define LEFT_WHEEL_PB0_Pin GPIO_PIN_0
#define LEFT_WHEEL_PB0_GPIO_Port GPIOB
#define LEFT_WHEEL_PB1_Pin GPIO_PIN_1
#define LEFT_WHEEL_PB1_GPIO_Port GPIOB
